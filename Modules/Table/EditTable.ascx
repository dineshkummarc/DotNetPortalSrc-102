...
protected void OnAddRow(object sender, EventArgs args)
{
	...
	else
	{
		...
		{
			dr[i] = ((TextBox)repAddRow.Items[i].FindControl("data")).Text;
		}
		td.Rows.Add(dr);
	}
	BindGrid();
...
protected void Grid_Update(Object sender, DataGridCommandEventArgs e) 
{
	...
	if(grid == gridDef)
	{
		...
		dr["width"] = ((TextBox)e.Item.Cells[3].Controls[0]).Text;
		SyncDataSet();
	}
	else
	{
		...
		{			
			dr[i] = ((TextBox)e.Item.Cells[i+2].Controls[0]).Text;
		}
	}
	grid.EditItemIndex = -1;
	BindGrid();
...
<h2>Definition</h2>
<asp:LinkButton id="lnkAddRow" runat="server" OnClick="OnAddRow" class="LinkButton">Add</asp:LinkButton>
<asp:datagrid id="gridDef" runat="server" AutogenerateColumns="false" OnEditCommand="Grid_Edit" OnCancelCommand="Grid_Cancel" OnUpdateCommand="Grid_Update" OnItemCommand="Grid_CartCommand">
	...
	<Columns>
		<asp:EditCommandColumn EditText="<img src=images/Edit.gif alt=Edit>" CancelText="<img src=images/delete.gif alt=Cancel>" UpdateText="<img src=images/edit.gif alt=Update>" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" ButtonType="LinkButton" HeaderStyle-Width="16px" />
		<asp:ButtonColumn ButtonType="LinkButton" Text="<img src=images/Delete.gif alt=Delete>" CommandName="Delete" />
		<asp:BoundColumn DataField="name" HeaderText="Column Name" HeaderStyle-Width="200px" />
		<asp:BoundColumn DataField="width" HeaderText="Width" HeaderStyle-Width="100px" />
	</Columns>
</asp:datagrid>
<h2>Data</h2>
<asp:LinkButton id="lnkAddDataRow" runat="server" OnClick="OnAddRow" cssclass="LinkButton">Add</asp:LinkButton>
...
<asp:datagrid id="gridData" runat="server" AutogenerateColumns="true" OnEditCommand="Grid_Edit" OnCancelCommand="Grid_Cancel" OnUpdateCommand="Grid_Update" OnItemCommand="Grid_CartCommand">
	...
	<ItemStyle CssClass="ListLine"></ItemStyle>
	<Columns>
		<asp:EditCommandColumn EditText="<img src=images/Edit.gif alt=Edit alt=Edit>" CancelText="<img src=images/delete.gif alt=Cancel>" UpdateText="<img src=images/edit.gif alt=Update>" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" ButtonType="LinkButton" />
		<asp:ButtonColumn ButtonType="LinkButton" Text="<img src=images/Delete.gif alt=Delete>" CommandName="Delete" />
	</Columns>
</asp:datagrid>
<p>
	<hr>
	<asp:LinkButton id="updateButton" Text="Update" runat="server" class="LinkButton" BorderStyle="none" OnClick="OnUpdate" />
	&nbsp;
	<asp:LinkButton id="cancelButton" Text="Cancel" CausesValidation="False" runat="server" class="LinkButton" BorderStyle="none" OnClick="OnCancel" />
</p>
